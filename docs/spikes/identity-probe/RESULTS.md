...
- Primary checkpoint: `nvidia/C-RADIOv4-SO400M` revision
  `c0457f5dc26ca145f954cd4fc5bb6114e5705ad8`, fp16 CUDA autocast, NVIDIA Open Model License
...
F1=0.667. A query scores as the maximum cosine against the target's reference views. The selected
threshold maximizes F1 subject to negative accuracy of at least 0.80. Images are EXIF-corrected,
...
|---|---:|---:|
| Chosen cosine threshold | 0.8376 | 0.8482 |
| Accept/reject F1 | **0.917** | 0.750 |
| Positive accuracy | **0.880 (22/25)** | 0.720 (18/25) |
| Negative accuracy | **0.960 (24/25)** | 0.800 (20/25) |
| ROC-AUC | **0.966** | 0.762 |
| Same cosine, mean +/- std | 0.8783 +/- 0.0413 | 0.8573 +/- 0.0313 |
| Different cosine, mean +/- std | 0.7568 +/- 0.0466 | 0.8248 +/- 0.0386 |
| Suggested minimum margin | 0.0423 | 0.0000 |
| Empirical escalation band | 0.8205-0.8376 | 0.8169-0.8675 |
| Forward latency p50 / p95 | 61.3 / 81.3 ms, N=36 | 25.6 / 25.9 ms, N=36 |
...
accepts all positives (25/25) but rejects only 11/25 negatives, confirming that the threshold
...
| Realistic | 0.903 | 0.824 (14/17) | 1.000 (17/17) | 0.952 |
| Combined | 0.917 | 0.880 (22/25) | 0.960 (24/25) | 0.966 |
...
- Use `min_cosine=0.8376`, `min_margin=0.0423`, and escalation band
  `0.8205-0.8376` as keys-demo starting values, configurable rather than constants.
