...
Readiness answers "can this process serve traffic", not "is a detector
finding anything" -- a service running the fixture detector and finding
nothing is a healthy, correctly-configured deployment (see
`config.DetectorKind`), not a broken one. Matches `media_gateway.readiness`.
